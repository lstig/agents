...
1. **Resolve and read the spec**, and its intent — the intent holds the *why* the spec assumes.
...
3. **Write** `docs/sdlc/plan/NNNN-slug.md` from the plan template, inheriting the spec's number and slug.
